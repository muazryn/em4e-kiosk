          ...
          {currentQuestionIndex === null && !isFinished && !isLearningActive && (
            <div className="flex-grow flex flex-col justify-between py-4 text-center animate-fade-in gap-5 sm:gap-6 relative">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-3.5 lg:gap-5 items-start justify-center my-1.5 flex-grow">
                ...
                <div className="lg:col-span-6 flex flex-col items-center justify-center gap-3 flex-grow">
                  <div className="w-full bg-slate-950/90 border-2 border-slate-800 rounded-[2rem] p-2.5 sm:p-3 shadow-2xl relative">
                    ...
                    <div className="w-full h-[155px] sm:h-[180px] lg:h-[195px] relative overflow-hidden bg-slate-950/40 rounded-2xl">
                      <svg viewBox="0 0 460 220" className="w-full h-full">
                        ...
                        >
                          {/* Little island group */}
                          <ellipse 
                            cx="350" cy="55" rx="14" ry="7" 
                            fill={activeGeo === "sg" ? "#fbbf24" : "#d97706"} 
                            stroke={activeGeo === "sg" ? "#fef3c7" : "#b45309"} 
                            strokeWidth="1.5"
                            className="transition-all duration-300 transform group-hover:scale-110"
                          />
                          {/* SGD Badge */}
                          <foreignObject x="370" y="45" width="45" height="26">
                            <div className="bg-[#ec4899] text-white text-[10.5px] font-mono font-black rounded-md px-1.5 py-0.5 shadow-md flex items-center justify-center border border-white/60">
                              SGD
                            </div>
                          </foreignObject>
                        </g>
                  ...
                  <div className="w-full bg-slate-950/90 border border-slate-800 rounded-xl p-2 sm:p-2.5 text-[11px] sm:text-xs text-left min-h-[48px] lg:min-h-[54px] flex items-center justify-start gap-2.5 shadow-xl select-none">
                    <div className="bg-amber-500/15 p-1.5 rounded-md text-amber-400 shrink-0">
                      <Info className="h-3.5 w-3.5 lg:h-4 lg:w-4 animate-bounce-slow" />
                    </div>
                    <motion.div 
                    ...
                    >
                      {activeGeo === "usa" ? (
                        <p className="text-[11px] sm:text-xs text-slate-100 font-medium leading-relaxed">
                        ...
                        <p className="text-[11px] sm:text-xs text-slate-100 font-medium leading-relaxed">
                          🇸🇬 <span className="text-rose-400 font-bold">SGD (Singapore Dollar)</span>: {language === "ms" ? "Singapura dan Malaysia berkongsi mata wang tunggal yang bersatu (dolar Malaya) sehingga berpisah pada tahun 1967!" : "Singapore and Malaysia shared a single unified currency (Malaya dollar) until splitting in 1967!"}
                        </p>
                      ) : activeGeo === "my" ? (
                        <p className="text-[11px] sm:text-xs text-slate-100 font-medium leading-relaxed">
                        ...
                        <p className="text-[11px] sm:text-xs text-slate-400 italic leading-relaxed font-bold">
                          {language === "ms" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 lg:gap-5 items-end mt-4 lg:mt-5">
                ...
                <div className="md:col-span-4 flex flex-col items-center justify-end h-full relative -translate-y-5 sm:-translate-y-6 lg:-translate-y-8">
                  {/* speech bubble */}
                  ...
                  <div className="h-24 sm:h-28 flex items-end">
                    <svg viewBox="0 0 120 120" className="w-24 h-24 sm:w-28 sm:h-28 drop-shadow-xl animate-bounce-slow">
                ...
                <div className="md:col-span-4 flex flex-col justify-center gap-2.5 py-2 max-w-[280px] mx-auto w-full relative -translate-y-5 sm:-translate-y-6 lg:-translate-y-8">
                  ...
                  <button
                    ...
                    className="w-full bg-[#e12a6f] hover:bg-[#c21e59] text-white font-black italic px-6 py-3 rounded-xl border border-dashed border-white uppercase tracking-wider text-xs sm:text-sm transition-all active:scale-95 shadow-[0_4px_12px_rgba(225,42,111,0.4)] flex items-center justify-center gap-2 cursor-pointer font-sans"
                  >
                    🚀 Bahasa Malaysia
                  </button>
                ...
                <div className="md:col-span-4 flex flex-col items-center justify-end h-full relative -translate-y-5 sm:-translate-y-6 lg:-translate-y-8">
                  ...
                  {/* vector head */}
                  <div className="h-24 sm:h-28 flex items-end">
                    <svg viewBox="0 0 120 120" className="w-24 h-24 sm:w-28 sm:h-28 drop-shadow-xl animate-bounce-slow" style={{ animationDelay: "0.2s" }}>
                ...
                <div className="space-y-3 lg:space-y-4 flex-grow text-left">
                  {learningStep === 0 ? (
                    ...
                    <div className="space-y-3 bg-slate-950/40 p-4 sm:p-5 rounded-2xl border border-slate-800/80 shadow-2xl">
                      ...
                      <div className="bg-slate-900/85 p-3.5 sm:p-4 rounded-xl border border-slate-850/80 space-y-4">
                        <div className="flex justify-between text-xs font-bold uppercase tracking-wider text-slate-300 font-mono">
                          ...
                          <span className="text-indigo-400 font-black bg-indigo-500/10 px-2.5 py-1 rounded font-mono border border-indigo-500/15">
                        ...
                        <div className="grid grid-cols-2 gap-3 pt-2.5 border-t border-slate-850/60 text-center">
                          <div className="p-2 sm:p-3 bg-slate-950/60 rounded-lg border border-slate-850">
                            <span className="text-[10px] text-slate-550 block uppercase font-mono mb-1 font-bold">{LOC_TEXT[language].wallet}</span>
                            <span className="text-xs sm:text-sm font-black text-amber-400 flex items-center justify-center gap-1 font-sans">
                              💵 10 USD / AUD
                            </span>
                          </div>
                          
                          <div className="p-2 sm:p-3 bg-slate-950/60 rounded-lg border border-slate-850">
                            <span className="text-[10px] text-slate-450 block uppercase font-mono mb-1 font-bold">{LOC_TEXT[language].receivedTrade}</span>
                            <span className="text-xs sm:text-sm font-black text-indigo-300 flex items-center justify-center gap-1 font-sans">
                      ...
                      <div className="p-2.5 bg-indigo-950/15 rounded-lg border border-indigo-500/15 text-[10px] sm:text-[11px] text-indigo-205 leading-normal text-left font-sans font-bold">
                    ...
                    <div className="space-y-3 bg-slate-950/40 p-3.5 sm:p-4.5 rounded-2xl border border-slate-800/80 shadow-2xl">
                        ...
                        <div className="bg-slate-950/80 p-2.5 sm:p-3 rounded-xl border border-slate-850 flex flex-col justify-between text-left text-xs min-h-[92px] sm:min-h-[102px]">
                          {activeHowWorkTopic ? (
                            <div className="space-y-2 animate-fade-in pb-1">
                              <span className="text-xs uppercase tracking-widest text-[#fbbf24] font-black font-mono flex items-center gap-1.5">
                              ...
                              <p className="text-[11px] sm:text-xs leading-relaxed text-slate-200 font-bold font-sans">
                            ...
                            <div className="flex flex-col items-center justify-center h-full text-slate-400 italic text-xs sm:text-sm text-center py-4">
                          ...
                          <div className="flex items-center justify-between mt-2 pt-2 border-t border-slate-900 text-[10px] text-slate-400">
                            ...
                            <div className="font-mono text-center text-[#b3c10a] font-black text-[11px] sm:text-xs">
                            ...
                            <div className="flex items-center gap-1.5 bg-rose-950/30 px-2 py-0.5 rounded border border-rose-900/20 font-sans">
                              ...
                              <span className="font-bold">Malaysia (RM)</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="p-3.5 bg-amber-950/15 rounded-xl border border-amber-500/15 text-[11px] sm:text-xs text-amber-200 leading-normal text-left font-sans font-bold">
                    ...
                    <div className="space-y-3 bg-slate-950/40 p-4 sm:p-4.5 rounded-2xl border border-slate-800/80 shadow-2xl animate-fade-in">
                      ...
                      <p className="text-[10.5px] sm:text-xs text-slate-350 leading-normal font-medium">
                        {LOC_TEXT[language].securingTrustDesc}
                      </p>

                      <div className="bg-slate-900/85 p-3 rounded-xl border border-slate-850 space-y-3">
                        <span className="text-[10px] font-black font-mono text-slate-400 block mb-1 uppercase tracking-wider">{LOC_TEXT[language].setCoinEdge}</span>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <button
                            ...
                            className={`p-2.5 sm:p-3 rounded-xl border-2 text-center transition-all cursor-pointer ${
                              selectedCoinEdge === "smooth"
                                ? "bg-rose-955/35 border-rose-500 text-rose-205 font-black shadow-md text-xs sm:text-xs"
                                : "bg-slate-950/60 border-slate-800 text-slate-400 hover:bg-slate-900 text-xs sm:text-xs"
                            }`}
                          >
                            <span className="block text-xs sm:text-sm font-bold">{LOC_TEXT[language].smoothRim}</span>
                            <span className="text-[9px] font-mono leading-none block mt-1">{language === "ms" ? "Mudah Dicukur" : "Easy to Shave / Clip"}</span>
                          </button>
                          ...
                          <button
                            ...
                            className={`p-2.5 sm:p-3 rounded-xl border-2 text-center transition-all cursor-pointer ${
                              selectedCoinEdge === "reeded"
                                ? "bg-emerald-955/35 border-emerald-500 text-emerald-205 font-black shadow-md text-xs sm:text-xs"
                                : "bg-slate-950/60 border-slate-800 text-slate-400 hover:bg-slate-900 text-xs sm:text-xs"
                            }`}
                          >
                            <span className="block text-xs sm:text-sm font-bold">{LOC_TEXT[language].reededRidges}</span>
                            <span className="text-[9px] font-mono leading-none block mt-1">{language === "ms" ? "Tepi Ridged Selamat" : "Secure Ridged Edges"}</span>
                          </button>
                        </div>
                        ...
                        <div className="flex flex-col items-center py-1 h-[78px] justify-center">
                          <div className={`w-13 h-13 rounded-full bg-gradient-to-r from-amber-400 to-yellow-600 flex items-center justify-center relative shadow-md ${
                            ...
                            <span className="text-[9px] font-mono font-black text-amber-950 bg-yellow-450/45 px-1 rounded">Au</span>
                            
                            {/* Visual indicator of shaved coin */}
                            {selectedCoinEdge === "smooth" && (
                              <span className="absolute -bottom-1.5 text-[8.5px] bg-red-600 text-white font-mono rounded px-2 animate-pulse leading-none py-0.5 font-bold tracking-wider font-sans">
                                {LOC_TEXT[language].shaveRisk}
                              </span>
                            )}
                            {selectedCoinEdge === "reeded" && (
                              <span className="absolute -bottom-1.5 text-[8.5px] bg-emerald-600 text-white font-mono rounded px-2 animate-pulse leading-none py-0.5 font-bold tracking-wider font-sans">
                      ...
                      <div className="p-2.5 bg-indigo-950/20 rounded-lg border border-indigo-500/15 text-[10px] sm:text-[11px] text-indigo-200 leading-normal font-semibold font-sans">
                  ...
                  {currentQuestion.options.map((option, idx) => {
                    ...
                    return (
                      <button
                        ...
                        className={`${btnStyle} min-h-[48px] text-left p-3.5 rounded-xl text-xs sm:text-xs transition-all focus:outline-none flex items-center justify-between gap-3.5 cursor-pointer font-bold shadow-md`}
                      >
            ...
            <div className="flex-grow flex flex-col md:flex-row gap-8 items-center justify-around animate-fade-in py-4">
              ...
              <div className="w-full md:w-[45%] flex flex-col items-center text-center space-y-4 border-b md:border-b-0 md:border-r border-slate-800/60 pb-6 md:pb-0 md:pr-8">
                ...
                <div className="space-y-1">
                  ...
                  <div className="mt-2 text-center font-mono">
                    <span className="text-[10px] text-slate-400 block uppercase">{LOC_TEXT[language].yourCuratedTitle}:</span>
                    <span className="bg-indigo-600/30 text-indigo-305 border border-indigo-500/40 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider inline-block mt-1">
              ...
              <div className="w-full md:w-[55%] flex flex-col justify-between h-full space-y-5">
                ...
                <div className="p-4 bg-slate-950/40 border border-slate-900 rounded-xl">
                  <h4 className="text-xs font-semibold text-slate-200 mb-1 text-left uppercase font-mono">{LOC_TEXT[language].curatorFeedback}:</h4>
                  <p className="text-xs text-slate-350 leading-relaxed text-left font-sans">
                ...
                <div className="bg-slate-950/60 p-3.5 rounded-xl border border-slate-800/80">
                  <span className="text-[10px] uppercase font-mono tracking-widest text-slate-450 block mb-2 text-left">{LOC_TEXT[language].quizLedger}:</span>
